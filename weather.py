...
#Function to get weather information form OpenWeatherMap API 
def get_weather(city): 
    API_key = "39e0d2c1dbb3984a6bbf3ef4a961c7a1"
...
search_button = ttkbootstrap.Button(root, text="Search", command=search, bootstyle="wearning")
